...
public class Main {
	...
	public static void main(String[] arg) {
		...
		if (combustivel == 4) {
			...
			System.out.println("Histórico de vendas do dia " + dataDia + "/" + dataMes + "/" + dataAno);
			System.out.printf("%n");
			System.out.println("Tabela de vendas por tipo de combustível:");
			System.out.println("Álcool: " + alcool + " Vendas, Litros: " + litrosAlcool + "L");
			...
			System.out.println("Total de Vendas: " + vendasTotal + " Lucro Médio por Venda: R$" + lucroMedio);

			System.out.printf(
					"%nLucro Bruto das vendas:%nLucro do Álcool: R$ %.2f %nLucro do Diesel: R$ %.2f %nLucro da Gasolina: R$ %.2f %nLucro Total: R$ %.2f %n",
					lucroAlcool, lucroDiesel, lucroGasolina, lucroTotal);
			System.out.printf("%nLucro Líquido do Dia: R$ %.2f %nEstimativa do Lucro Líquido Mensal: R$ %.2f",
